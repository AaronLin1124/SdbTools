...
public partial class MainWindow : Window
{
    ...
    private async void BtnCheckUpdate_Click(object? sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            {
                await ShowMessage(t[21], $"{t[29]}: {_version}\n{t[30]}");
            }
        }
        catch
        {
            await ShowMessage(t[19], $"{t[31]}\n{t[32]}");
        }
    }
